...
// }
  return (
 <div className='w-full bg-black h-screen duration-200 'style ={{backgroundColor: color}}>
...
<button 
      ...
      className='outline-none px-4 py-1 rounded-full text-black  shadow-lg 'style ={{backgroundColor:'violet'}}> violet</button>

<button 
onClick={() => setColor('lightblue')}
className='text-black px-4 py-1 outline-none rounded-full 'style ={{backgroundColor:'lightblue'}}>
  blue
</button>
